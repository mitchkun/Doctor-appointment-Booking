  ...
  final ratingList = [
    {
      ...
      'rating': 5,
      'review': 'Really good place, the nurses are nice.',
      'time': 'May 2021'
    },
    {
      'name': 'Mbabane Branch',
      ...
      'rating': 4.9,
      'review': 'Great place i have ever seen.',
      'time': 'March 2021'
    }
  ];
              ...
              return ClipRRect(
                ...
                child: Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text(
                        'Driven for our passion for pathology, Lifespan Diagnostics seeks to be the leaders in pathology and diagnostics services in Eswatini.',
          ...
          child: ClipRRect(
            ...
            child: GoogleMap(
              ...
              onMapCreated: (GoogleMapController controller) {
                Marker m = Marker(
                    markerId: MarkerId('1'),
                    position: LatLng(26.5082, 31.3713));
                setState(() {
                  markers.add(m);
                });
              },
              initialCameraPosition: CameraPosition(
                  target: LatLng(26.5082, 31.3713), zoom: 8),
            ),
          ),
        ),
      ],
